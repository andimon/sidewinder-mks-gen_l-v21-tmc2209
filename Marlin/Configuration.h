...
#define STRING_CONFIG_H_AUTHOR "(Andre' Vella)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Andre's Sidewinder X1"
...
#define PID_MAX 218 // Limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
...
#define EXTRUDE_MAXLENGTH 200//300
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.52, 80.85, 401.20, 414 }//{ 641, 641, 3198.3, 3363 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 40, 40 }//{ 300, 300, 50, 40 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 10, 50 }//{ 600, 600, 50, 50 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION       { 3000, 3000, 100, 10000 } //{ 2000, 2000, 100, 10000 }
 ...
 */
#define DEFAULT_ACCELERATION          3000//750    // X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  10000    // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   3000//2000     // X, Y, Z acceleration for travel (non printing) moves
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 39, -41, -2.5 } //{ 38, -34, -1.0 }
...
#define XY_PROBE_FEEDRATE 8000 //(150*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (20*60) //(10*60)
...
#define X_BED_SIZE 300//305
#define Y_BED_SIZE 300//305
...
#define HOMING_FEEDRATE_MM_M { (80*60), (80*60), (20*60) }//{ (80*60), (80*60), (20*60) }
...
//#define RGBW_LED
  ...
  #define RGB_LED_G_PIN 43 //4
  #define RGB_LED_B_PIN 4 //43
